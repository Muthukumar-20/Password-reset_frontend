...
const Forgetpassword = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios
          .post("https://password-reset-backend-4dnh.onrender.com/api/auth/forgot-password", {email})
          .then((res) => {
...
<div className='border-black border flex justify-center m-32 p-20 w-[400px] rounded-md'>
        ...
        <button className='border border-black rounded-md w-32 h-10 font-bold hover:bg-red-600 hover:text-white' type="submit">Send</button>
